...
from src.controllers.event import Controller
from src.views.event import View
...
class TestController(MixinSetup):
    def test_session_is_expired(self, monkeypatch):
        ...
        monkeypatch.setattr(View, "print_commercial_menu", self.mock_permission_denied)
        monkeypatch.setattr(View, "print_support_menu", self.mock_permission_denied)
    ...
    def test_run_to_home_menu(self, monkeypatch):
        ...
        # allowed path
        monkeypatch.setattr(View, "print_gestion_menu", lambda *args, **kwargs: None)
